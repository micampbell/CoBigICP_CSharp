function [ R, T, Flag ] = CoBigICP_fun(refCloud, movCloud, MovData, RefData, MovInfo, RefInfo, Tf0, DistThr, AngThr, sigma_times)
if nargin == 0
    clc; close all;
    ...
    refCloud = createns(RefData');
    movCloud = createns(MovData');
end
